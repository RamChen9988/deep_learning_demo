...
class SentimentAnalysisModel:
    ...
    def build_model(self, num_classes):
        ...
        self.model = Sequential([
            ...
            # LSTM层：捕获序列信息
            LSTM(units=128, return_sequences=False),  # 双向LSTM捕获上下文 return_sequences=True
            # Dense(64, activation='relu'),  # 增加全连接层
            # Dropout层：防止过拟合
            #防止过拟合：
            #增加 Dropout 比例（如 0.5→0.6）
            Dropout(0.5),
...
def main():
    # 数据集路径
    data_path = 'data/Simplified_Chinese_Multi-Emotion_Dialogue_Dataset.csv'
